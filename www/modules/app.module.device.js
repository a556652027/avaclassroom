...
//===============================================================================
function CsRequestDeviceSelectAllCount(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
// DESC : 設備資料列表
//===============================================================================
function CsRequestDeviceSelectAllRecords(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
// DESC : 設備單筆詳細資料
//===============================================================================
function CsRequestDeviceSelectOneRecord(device_cid, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
...
// DESC : 新增設備
//===============================================================================
function CsRequestDeviceInsertOneRecord(
  device_data,
  callback,
  abortController,
) {
...
// DESC : 更新設備
//===============================================================================
function CsRequestDeviceUpdateOneRecord(
  device_data,
  callback,
  abortController,
) {
...
// DESC : 更新設備
//===============================================================================
function CsRequestDeviceSpec04BGroupByCondition00(
  owner_cid,
  product_type,
  callback,
  abortController,
...
// DESC : 發起非同步設備匯出任務
//===============================================================================
function CsRequestDeviceExportStart(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
// DESC : 查詢匯出任務進度
//===============================================================================
function CsRequestDeviceExportStatus(job_id, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
...
//===============================================================================
function CsRequestDeviceExportDownload(job_id, callback) {
