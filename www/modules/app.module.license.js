...
//===============================================================================
function CsRequestLicenseSelectAllCount(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
//===============================================================================
function CsRequestLicenseGetStatistics(
  condition_type,
  condition_value,
  today_date,
  last_year_date,
...
// DESC : 訂單資料列表
//===============================================================================
function CsRequestLicenseSelectAllRecords(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
// DESC : 訂單單筆詳細資料
//===============================================================================
function CsRequestLicenseSelectOneRecordByCID(
  license_cid,
  callback,
  abortController,
) {
...
// DESC : 新增訂單
//===============================================================================
function CsRequestLicenseInsertOneRecord(
  order_data,
  callback,
  abortController,
) {
...
// DESC : 更新訂單
//===============================================================================
function CsRequestLicenseUpdateOneRecord(
  order_data,
  callback,
  abortController,
) {
...
// DESC : 發起非同步匯出任務
//===============================================================================
function CsRequestLicenseExportStart(
  condition_type,
  condition_value,
  b_time,
  e_time,
...
// DESC : 查詢匯出任務進度
//===============================================================================
function CsRequestLicenseExportStatus(job_id, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
...
//===============================================================================
function CsRequestLicenseExportDownload(job_id, callback) {
