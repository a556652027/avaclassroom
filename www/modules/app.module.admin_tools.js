...
//===============================================================================
function CsRequestRebuildCache(callback, abortController) {
...
//===============================================================================
function CsRequestResetUnregCountProxy(
  license_cid,
  count,
  callback,
  abortController,
...
//===============================================================================
function CsRequestDisableKeyProxy(license_cid, callback, abortController) {
  const session_token = window.sessionStorage.getItem("session_token");
  if (!session_token) {
    alert("驗證失敗：找不到登入狀態，請重新登入！");
    if (callback) callback(false, null);
...
//===============================================================================
function CsRequestEnableKeyProxy(license_cid, callback, abortController) {
  const session_token = window.sessionStorage.getItem("session_token");
  if (!session_token) {
    alert("驗證失敗：找不到登入狀態，請重新登入！");
    if (callback) callback(false, null);
...
//===============================================================================
function CsRequestBulkGenKeyProxy(
  product,
  version,
  license,
  model,
...
//===============================================================================
function CsRequestBulkRevokeProxy(
  product,
  version,
  keysArray,
  callback,
...
//===============================================================================
function CsRequestAddProductProxy(
  product,
  version,
  duration,
  valid_count,
...
//===============================================================================
function CsRequestDeleteProductProxy(
  product,
  version,
  callback,
  abortController,
