...
//        condition_value :  依照 type 去當 parent_cid 或 group_cid
//===============================================================================
function CsRequestMemberSelectAllRecordsByCondition(
  condition_type,
  condition_value,
  search_name,
  offset,
...
// DESC : 取得使用者的詳細資料
//===============================================================================
function CsRequestMemberSelectOneRecordByMemberCID(
  member_cid,
  callback,
  abortController,
) {
...
//===============================================================================
function CsRequestMemberInsertOneRecordByParentCID(
  parent_cid,
  member_data,
  callback,
  abortController,
...
// DESC : 新增使用者資料
//===============================================================================
function CsRequestMemberUpdateOneRecordByMemberCID(
  member_data,
  callback,
  abortController,
) {
...
// DESC : 寄送mail通知使用者
//===============================================================================
function CsRequestMemberSendEMail(member_cid, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
