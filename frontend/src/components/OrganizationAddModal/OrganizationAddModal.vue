<template>
  <div v-if="visible" class="ui-modal-overlay org-add-modal" style="z-index: 9999">
    <div class="ui-modal modal-content" style="max-width: 800px">
      <div class="page-caption" style="display: flex; align-items: center; justify-content: space-between">
        <div style="display: flex; align-items: center">
          ...
          <h1 style="font-size: 20px; line-height: 125%">
      ...
      <div class="org-add-grid">
        ...
        <div class="org-row">
          ...
          <div class="org-field" style="width: 358px">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px">
              <label style="margin: 0">{{ t('organization.billing_addr') }}</label>
              <div style="display: flex; align-items: center; gap: 4px">
                ...
                />
                <span class="org-addr-hint">同公司地址</span>
              </div>
            </div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 1rem">
          <button type="button" class="btn-tertiary modal-action-btn" @click="hide">
            {{ t('common.cancel') }}
          </button>
          <button type="button" class="btn-primary modal-action-btn" @click="save">
            {{ t('common.save') }}
          </button>
        </div>
      </div>
