//  (原 www/modules/app.module.organization.js 原封搬移)
...
//===============================================================================
export function CsRequestGroupSelectAllCountByCondition(
  condition_type,
  condition_value,
  callback,
  abortController,
...
//===============================================================================
export function CsRequestGroupSelectAllRecordsByCondition(
  condition_type,
  condition_value,
  offset,
  row_count,
...
// DESC : 取得單一組織的詳細資料
//===============================================================================
export function CsRequestGroupSelectOneRecordByGroupCID(
  group_cid,
  callback,
  abortController,
) {
...
// DESC : 新增組織資料
//===============================================================================
export function CsRequestGroupInsertOneRecordByOwnerCID(
  group_data,
  callback,
  abortController,
) {
...
// DESC : 更新組織資料
//===============================================================================
export function CsRequestGroupUpdateOneRecordByGroupCID(
  group_data,
  callback,
  abortController,
) {
...
//===============================================================================
export function CsRequestGroupGetOwnedProducts(target_group_cid, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
