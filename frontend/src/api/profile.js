//  (原 www/modules/app.module.profile.js 原封搬移)
...
// DESC : 取得使用者的詳細資料
//===============================================================================
export function CsRequestProfileSelectOne(profile_cid, callback, abortController) {
...
// DESC : 新增使用者資料
//===============================================================================
export function CsRequestProfileUpdateOne(profile_data, callback, abortController) {
  if (!window.Cyberspace || !window.Cyberspace.Client) {
    if (callback) callback(new Error("Network Client not ready"), null);
    return;
  }
